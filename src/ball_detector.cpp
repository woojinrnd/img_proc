    ...
    not_found_count_(0)
{
  ...
  circles_pub_ = nh_.advertise<img_proc::CircleSetStamped>("circle_set", 100);
  ...
  // web setting
  param_pub_ = nh_.advertise<img_proc::BallDetectorParams>("current_params", 1);
...
void BallDetector::dynParamCallback(img_proc::DetectorParamsConfig &config, uint32_t level)
{
...
bool BallDetector::setParamCallback(img_proc::SetParameters::Request &req, img_proc::SetParameters::Response &res)
{
...
bool BallDetector:: getParamCallback(img_proc::GetParameters::Request &req, img_proc::GetParameters::Response &res)
{
...
{
  img_proc::BallDetectorParams params;
