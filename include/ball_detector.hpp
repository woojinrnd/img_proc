...
#include "ball_detector_config.hpp"


// #include "img_proc/BallDetectorParams.h"
#include "img_proc/DetectorParamsConfig.h"
#include "img_proc/CircleSetStamped.h"
#include "img_proc/GetParameters.h"
#include "img_proc/SetParameters.h"
...
class BallDetector
{
 ...
 protected:
  ...
  void dynParamCallback(img_proc::DetectorParamsConfig &config, uint32_t level);
  void enableCallback(const std_msgs::Bool::ConstPtr &msg);

  void paramCommandCallback(const std_msgs::String::ConstPtr &msg);
  bool setParamCallback(img_proc::SetParameters::Request &req, img_proc::SetParameters::Response &res);
  bool getParamCallback(img_proc::GetParameters::Request &req, img_proc::GetParameters::Response &res);
  void resetParameter();
  void publishParam();
  ...
  img_proc::CircleSetStamped circles_msg_;
  ...
  dynamic_reconfigure::Server<img_proc::DetectorParamsConfig> param_server_;
  dynamic_reconfigure::Server<img_proc::DetectorParamsConfig>::CallbackType callback_fnc_;
};       
